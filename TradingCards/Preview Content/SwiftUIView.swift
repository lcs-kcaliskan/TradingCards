        ...
        VStack(alignment: .center, spacing: 0) {
            ...
            HStack { //Stats
                VStack{
                    ...
                    Text("\(providedPlayerCard.pointsPerGame)PPG")
                        .foregroundColor(.white)
                        .font(.system(size: 20, weight: .semibold))
                    Text("\(providedPlayerCard.reboundsPerGame)RPG")
                        .foregroundColor(.white)
                        .font(.system(size: 20, weight: .semibold))
                    Text("\(providedPlayerCard.assistsPerGame)APG")
                        .foregroundColor(.white)
                        .font(.system(size: 20, weight: .semibold))
                    Text("\(providedPlayerCard.fieldGoalPercentage)%FG")
                        .foregroundColor(.white)
                        .font(.system(size: 20, weight: .semibold))
                }.padding(20)
                Spacer()
